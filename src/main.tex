...
\citep{Paisante14, Saggioro15}. In these papers, we've used the algorithm presented here
...
a unique greatest lower bound (or meet). 
...
unique greatest lower bound is the greatest common divisor.
...
gives us, later, a way to answer the question: ``do points $p_1$ and
